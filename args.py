...
def get_setup_args():
    ...
    parser.add_argument('--dev_meta_file',
                        type=str,
                        default=data_path('dev_meta.json'))
    parser.add_argument('--test_meta_file',
                        type=str,
                        default=data_path('test_meta.json'))
    parser.add_argument('--word2idx_file',
                        type=str,
                        default=data_path('word2idx.json'))
    parser.add_argument('--char2idx_file',
                        type=str,
                        default=data_path('char2idx.json'))
    parser.add_argument('--answer_file',
                        type=str,
                        default=data_path('answer.json'))
...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',
                        type=str,
                        default=data_path('train.npz'))
    parser.add_argument('--dev_record_file',
                        type=str,
                        default=data_path('dev.npz'))
    parser.add_argument('--test_record_file',
                        type=str,
                        default=data_path('test.npz'))
    parser.add_argument('--word_emb_file',
                        type=str,
                        default=data_path('word_emb.json'))
    parser.add_argument('--char_emb_file',
                        type=str,
                        default=data_path('char_emb.json'))
    parser.add_argument('--train_eval_file',
                        type=str,
                        default=data_path('train_eval.json'))
    parser.add_argument('--dev_eval_file',
                        type=str,
                        default=data_path('dev_eval.json'))
    parser.add_argument('--test_eval_file',
                        type=str,
                        default=data_path('test_eval.json'))
...
def data_path(file_name):
    return os.environ.get('DATA_DIR', './data') + '/' + file_name
